...
class GUIManager(DirectObject):
    ...
    def setup_splash_screen(self):
          ...
          #text = DirectLabel(text = "Please Pess Enter",pos = (0,0,0.2),scale = 0.1,text_bg=(255,123,0,0))
    ...
    def execute_new_game(self):
        ...
        #self.field_bg = loader.loadModel("field_Background.egg")
        #np = render.attachNewNode(self.field_bg)
        #self.field_bg.reparentTo(base.camera)
        #self.field_bg.setPos(10,(base.camera.getY() - 29),10)
        #self.field_bg.setPos(0,( 39),0)
        #self.field_bg.setScale(1)
        #self.field_bg.setBin('foreground', 1)
    ...
    def setup_settings_screen(self):
        ...
        self.settings_frame = DirectFrame(frameSize = (1,-1,1,-1),frameColor = (0.2,0,0.6,0.9),pos = (0,0,0))
