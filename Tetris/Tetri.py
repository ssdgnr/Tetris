...
class Tetri(DirectObject):
    ...
    def __init__(self,field,GMM):
        ...
        types = [[1,4,5,6],[1,5,6,7],[2,4,5,6],[1,2,5,6],[1,5,9,13],[1,2,4,5],[1,2,6,7]]
        ...
        if(self.descending == True):
         self.accept("w", self.translate, extraArgs = [True,2])
         ...
         self.accept("l", self.rotate, extraArgs = [])
